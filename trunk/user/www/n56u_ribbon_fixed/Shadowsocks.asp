...
function switch_ss_type(){
	var v = document.form.ss_type.value; //0:ss-orig;1:ssr;2:trojan
	if (v == 0){
		...
		showhide_div('row_ss_timeout', 1);
		showhide_div('row_ss_tunnel_reconnect', 1);
		showhide_div('row_ss_tunnel_enable', 1);
		showhide_div('row_ss_tunnel_remote', 1);
		showhide_div('row_ss_tunnel_port', 1);
		showhide_div('row_ss_tunnel_mtu', 1);
		showhide_div('row_ss_mtu', 1);
		showhide_div('row_ss_server_sni', v);
	}else if (v == 1){
		showhide_div('row_ss_protocol', v);
		showhide_div('row_ss_proto_param', v);
		showhide_div('row_ss_obfs', v);
		...
		showhide_div('row_ss_timeout', v);
		showhide_div('row_ss_tunnel_reconnect', v);
		showhide_div('row_ss_tunnel_enable', v);
		showhide_div('row_ss_tunnel_remote', v);
		showhide_div('row_ss_tunnel_port', v);
		showhide_div('row_ss_tunnel_mtu', v);
		showhide_div('row_ss_mtu', v);
		showhide_div('row_ss_server_sni', 0);
	}else{
		showhide_div('row_ss_protocol', 0);
		showhide_div('row_ss_proto_param', 0);
		showhide_div('row_ss_obfs', 0);
		showhide_div('row_ss_obfs_param', 0);
		showhide_div('row_ss_method', 0);
		showhide_div('row_ss_timeout', 0);
		showhide_div('row_ss_tunnel_reconnect', 0);
		showhide_div('row_ss_tunnel_enable', 0);
		showhide_div('row_ss_tunnel_remote', 0);
		showhide_div('row_ss_tunnel_port', 0);
		showhide_div('row_ss_tunnel_mtu', 0);
		showhide_div('row_ss_mtu', 0);
		showhide_div('row_ss_server_sni', 1);
	}
}
                            ...
                            <div class="round_bottom">
                                <div class="row-fluid">
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0" class="table">
                                        ...
                                        <tr id="row_ss_mtu" style="display:none;"> <th><#menu5_16_18#></th>
                                            <td>
                                        ...
                                        <tr> <th><#menu5_16_4#></th>
                                            <td>
                                                <input type="text" maxlength="64" class="input" size="64" name="ss_server" style="width: 217px" value="<% nvram_get_x("","ss_server"); %>">
                                            </td>
                                        </tr>

                                        <tr> <th><#menu5_16_5#></th>
                                            <td>
                                                <input type="text" maxlength="6" class="input" size="6" name="ss_server_port" style="width: 83px" value="<% nvram_get_x("","ss_server_port"); %>">
                                            </td>
                                        </tr>

                                        <tr> <th><#menu5_16_6#></th>
                                            <td>
                                                <input type="password" maxlength="64" class="input" size="64" name="ss_key" id="ss_key" style="width: 182px" value="<% nvram_get_x("","ss_key"); %>">
                                                <button style="margin-left: -5px;" class="btn" type="button" onclick="passwordShowHide('ss_key')"><i class="icon-eye-close"></i></button>
                                            </td>
                                        </tr>	

                                        <tr id="row_ss_server_sni" style="display:none;"> <th><#menu5_16_27#></th>
                                            <td>
                                                <input type="text" maxlength="64" class="input" size="64" name="ss_server_sni" style="width: 217px" value="<% nvram_get_x("","ss_server_sni"); %>">
                                            </td>
                                        </tr>
                                        
                                        <tr id="row_ss_timeout" style="display:none;"> <th><#menu5_16_21#></th>
                                            <td>
                                                <input type="text" maxlength="6" class="input" size="6" name="ss_timeout" style="width: 83px" value="<% nvram_get_x("","ss_timeout"); %>">
                                            </td>
                                        </tr>

                                        <tr id="row_ss_method" style="display:none;"> <th><#menu5_16_7#></th>
                                            <td>
                                                <select name="ss_method" class="input" style="width: 228px">
                                        ...
                                        <tr id="row_ss_protocol" style="display:none;"> <th><#menu5_16_22#></th>
                                            <td>
                                                <select name="ss_protocol" class="input" style="width: 228px">   
                                        ...
                                        <tr id="row_ss_proto_param" style="display:none;"> <th><#menu5_16_23#></th>
                                            <td>
                                                <input type="text" maxlength="64" class="input" size="64" name="ss_proto_param" style="width: 217px" value="<% nvram_get_x("","ss_proto_param"); %>">
                                            </td>
                                        </tr>
                                        
                                        <tr id="row_ss_obfs" style="display:none;"> <th><#menu5_16_24#></th>
                                            <td>
                                                <select name="ss_obfs" class="input" style="width: 228px">   
                                        ...
                                        <tr id="row_ss_obfs_param" style="display:none;"> <th><#menu5_16_25#></th>
                                            <td>
                                                <input type="text" maxlength="64" class="input" size="64" name="ss_obfs_param" style="width: 217px" value="<% nvram_get_x("","ss_obfs_param"); %>">
                                            </td>
                                        </tr>

                                        <tr> <th colspan="2" style="background-color: #E3E3E3;"><#menu5_16_12#></th> </tr>

                                        <tr id="row_ss_tunnel_reconnect" style="display:none;"> <th><#InetControl#></th>
                                            <td style="border-top: 0 none;" colspan="2">
                                                <input type="button" id="btn_connect_2" class="btn btn-info" value=<#Connect#> onclick="submitInternet('Reconnect_ss_tunnel');">
                                            </td>
                                        </tr>

                                        <tr id="row_ss_tunnel_enable" style="display:none;"> <th><#menu5_16_13#></th>
                                            <td>
                                                <div class="main_itoggle">
                                        ...
                                        <tr id="row_ss_tunnel_remote" style="display:none;"> <th><#menu5_16_14#></th>
                                            <td>
                                                <input type="text" maxlength="32" class="input" size="32" name="ss-tunnel_remote" style="width: 217px" value="<% nvram_get_x("","ss-tunnel_remote"); %>">
                                            </td>
                                        </tr>

                                        <tr id="row_ss_tunnel_port" style="display:none;"> <th><#menu5_16_15#></th>
                                            <td>
                                                <input type="text" maxlength="6" class="input" size="6" name="ss-tunnel_local_port" style="width: 83px" value="<% nvram_get_x("", "ss-tunnel_local_port"); %>">
                                            </td>
                                        </tr>

                                        <tr id="row_ss_tunnel_mtu" style="display:none;"> <th><#menu5_16_16#></th>
                                            <td>
                                        ...
                                        <tr>
                                            <th><#menu5_17_1#>&nbsp;&nbsp;&nbsp;&nbsp;<span class="label label-info" style="padding: 5px 5px 5px 5px;" id="chnroute_count"></span></th>
                                            <td style="border-top: 0 none;" colspan="2">
                                        ...
                                        <tr>
                                            <th><#menu5_17_1#>&nbsp;&nbsp;&nbsp;&nbsp;<span class="label label-info" style="padding: 5px 5px 5px 5px;" id="gfwlist_count"></span></th>
                                            <td style="border-top: 0 none;" colspan="2">
