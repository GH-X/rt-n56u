                                ...
                                <div class="row-fluid">
                                    ...
                                    <table width="100%" cellpadding="4" cellspacing="0" class="table">
                                        <tr>
                                            ...
                                            <textarea rows="8" class="span12" style="resize:none; font-family:'Courier New', Courier, mono; font-size:13px;" readonly="readonly" wrap="off" id="textarea"><% nvram_dump("ss-local.log",""); %></textarea>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="3" style="border-top: 0 none; padding-bottom: 0px;">
